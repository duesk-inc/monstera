...
BEGIN
    ...
    approver_manager_id := 'g0eebc99-9c0b-4ef8-bb6d-6bb9bd380f01';
    INSERT INTO expense_approver_settings (id, approval_type, approver_id, is_active, priority, created_by) VALUES 
    (approver_manager_id, 'manager', admin_id, true, 1, admin_id)
    ON CONFLICT (id) DO NOTHING;

    -- 役員承認者としてもadmin@duesk.co.jpを設定
    approver_executive_id := 'g0eebc99-9c0b-4ef8-bb6d-6bb9bd380f02';
    INSERT INTO expense_approver_settings (id, approval_type, approver_id, is_active, priority, created_by) VALUES 
    (approver_executive_id, 'executive', admin_id, true, 1, admin_id)
    ON CONFLICT (id) DO NOTHING;
END $$;