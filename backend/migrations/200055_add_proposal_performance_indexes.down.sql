-- 提案テーブルのパフォーマンス最適化インデックスを削除

-- engineer_proposalsテーブルのインデックス削除
...
-- engineer_proposal_questionsテーブルのインデックス削除
DROP INDEX IF EXISTS idx_proposal_questions_proposal_deleted;
