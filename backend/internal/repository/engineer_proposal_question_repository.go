...
type EngineerProposalQuestionRepository interface {
	...
	GetByID(ctx context.Context, id string) (*model.EngineerProposalQuestion, error)
	Update(ctx context.Context, question *model.EngineerProposalQuestion) error
	Delete(ctx context.Context, id string) error

	// 質問管理
	GetByProposalID(ctx context.Context, proposalID string, filter QuestionFilter) ([]*model.EngineerProposalQuestion, int64, error)
	GetByProposalIDSimple(ctx context.Context, proposalID string) ([]*model.EngineerProposalQuestion, error)
	...
	// 回答管理
	UpdateResponse(ctx context.Context, id string, responseText string, salesUserID string) error
	MarkAsResponded(ctx context.Context, id string, respondedAt time.Time) error
	GetUnansweredQuestions(ctx context.Context, proposalID string) ([]*model.EngineerProposalQuestion, error)
	GetQuestionsBySalesUser(ctx context.Context, salesUserID string, filter QuestionFilter) ([]*model.EngineerProposalQuestion, int64, error)

	// 統計・分析クエリ
	CountQuestionsByProposal(ctx context.Context, proposalID string) (int64, error)
	CountPendingQuestionsByProposal(ctx context.Context, proposalID string) (int64, error)
	...
	GetSalesResponseStats(ctx context.Context, salesUserID string, startDate, endDate time.Time) (*SalesQuestionStats, error)
	...
	GetResponseTimeDistribution(ctx context.Context, salesUserID string) (*ResponseTimeDistribution, error)

	// バルク操作
	BulkAssignSalesUser(ctx context.Context, questionIDs []string, salesUserID string) error
	BulkMarkAsUrgent(ctx context.Context, questionIDs []string) error
	BulkDelete(ctx context.Context, questionIDs []string) error
}
...
func (r *engineerProposalQuestionRepository) Create(ctx context.Context, question *model.EngineerProposalQuestion) error {
	if err := r.db.WithContext(ctx).Create(question).Error; err != nil {
		r.logger.Error("Failed to create engineer proposal question",
			zap.Error(err),
			zap.String("proposal_id", question.ProposalID),
...
func (r *engineerProposalQuestionRepository) GetByID(ctx context.Context, id string) (*model.EngineerProposalQuestion, error) {
	...
	if err := r.db.WithContext(ctx).
		...
		if err == gorm.ErrRecordNotFound {
			r.logger.Warn("Engineer proposal question not found", zap.String("id", id))
			return nil, err
		}
...
func (r *engineerProposalQuestionRepository) Delete(ctx context.Context, id string) error {
	...
	if result.RowsAffected == 0 {
		r.logger.Warn("Engineer proposal question not found for deletion", zap.String("id", id))
		return gorm.ErrRecordNotFound
	}

	r.logger.Info("Engineer proposal question deleted successfully", zap.String("id", id))
	return nil
}

// GetByProposalID 提案IDで質問一覧を取得（フィルター付き）
func (r *engineerProposalQuestionRepository) GetByProposalID(ctx context.Context, proposalID string, filter QuestionFilter) ([]*model.EngineerProposalQuestion, int64, error) {
...
func (r *engineerProposalQuestionRepository) GetByProposalIDSimple(ctx context.Context, proposalID string) ([]*model.EngineerProposalQuestion, error) {
	var questions []*model.EngineerProposalQuestion
...
func (r *engineerProposalQuestionRepository) UpdateResponse(ctx context.Context, id string, responseText string, salesUserID string) error {
	now := time.Now()
...
func (r *engineerProposalQuestionRepository) MarkAsResponded(ctx context.Context, id string, respondedAt time.Time) error {
	result := r.db.WithContext(ctx).
		Model(&model.EngineerProposalQuestion{}).
		Where("id = ?", id).
		Updates(map[string]interface{}{
...
func (r *engineerProposalQuestionRepository) GetUnansweredQuestions(ctx context.Context, proposalID string) ([]*model.EngineerProposalQuestion, error) {
	var questions []*model.EngineerProposalQuestion
...
func (r *engineerProposalQuestionRepository) GetQuestionsBySalesUser(ctx context.Context, salesUserID string, filter QuestionFilter) ([]*model.EngineerProposalQuestion, int64, error) {
	query := r.db.WithContext(ctx).
		Model(&model.EngineerProposalQuestion{}).
		Preload("Proposal").
...
func (r *engineerProposalQuestionRepository) CountQuestionsByProposal(ctx context.Context, proposalID string) (int64, error) {
	var count int64
...
func (r *engineerProposalQuestionRepository) CountPendingQuestionsByProposal(ctx context.Context, proposalID string) (int64, error) {
	var count int64
...
func (r *engineerProposalQuestionRepository) GetSalesResponseStats(ctx context.Context, salesUserID string, startDate, endDate time.Time) (*SalesQuestionStats, error) {
...
func (r *engineerProposalQuestionRepository) GetResponseTimeDistribution(ctx context.Context, salesUserID string) (*ResponseTimeDistribution, error) {
...
func (r *engineerProposalQuestionRepository) BulkAssignSalesUser(ctx context.Context, questionIDs []string, salesUserID string) error {
...
func (r *engineerProposalQuestionRepository) BulkMarkAsUrgent(ctx context.Context, questionIDs []string) error {
	if len(questionIDs) == 0 {
		return nil
	}
...
// BulkDelete 一括削除
func (r *engineerProposalQuestionRepository) BulkDelete(ctx context.Context, questionIDs []string) error {
	if len(questionIDs) == 0 {
		return nil
	}
