...
type WorkHistoryTechnology struct {
	...
	TechnologyID   string    `gorm:"type:varchar(36);index:idx_work_history_technologies_technology_id" json:"technology_id"` // technology_masterのID
	...
	TechnologyMaster *TechnologyMaster   `gorm:"foreignKey:TechnologyID" json:"technology_master,omitempty"`
}
