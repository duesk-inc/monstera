-- E2E Test Seed Data for Monstera (Basic Version)
-- This file contains basic test data for E2E testing
-- Creates only users with existing table structure
...
INSERT INTO users (
    ...
    '$2a$10$JLVcXydvp3XKpqK3TdbUGOYJ1KiXRZGBKLhXBFZQKhJSLHvQHJCLy',
    'テスト', '営業', 'テスト', 'エイギョウ',
    6, -- sales_rep role (assuming this is valid)
    1, -- active
    NOW(),
    NOW()
);
